...
class VariableSequenceClassification:
    ...
    def error(self):
        ...
        return (tf.reduce_mean(tf.cast(mistakes, tf.float32)), tf.argmax(self.prediction, 1))
    ...
    def _last_relevant(output, length):
        ...
        #print(batch_size, max_length, output_size)
...
if __name__ == '__main__':
    ...
    for epoch in range(30):
        ...
        error, pred = sess.run(model.error, {data: test.data, target: test.target})
        print(50*'=')
        print(confusion_matrix(np.argmax(test.target, 1), pred))
        print(50*'=')
